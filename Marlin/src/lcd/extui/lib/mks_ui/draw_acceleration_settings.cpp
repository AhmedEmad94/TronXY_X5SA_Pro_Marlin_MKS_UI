...
void lv_draw_acceleration_settings(void) {
  ...
  if (uiCfg.para_ui_page != 1) {
    ...
    lv_btn_set_style(buttonPrintText, LV_BTN_STYLE_REL, &tft_style_lable_rel);  /*Set the button's released style*/
    lv_btn_set_style(buttonPrintText, LV_BTN_STYLE_PR, &tft_style_lable_pre);   /*Set the button's pressed style*/
    ...
    lv_btn_set_style(buttonRetraText, LV_BTN_STYLE_REL, &tft_style_lable_rel);  /*Set the button's released style*/
    lv_btn_set_style(buttonRetraText, LV_BTN_STYLE_PR, &tft_style_lable_pre);   /*Set the button's pressed style*/
    ...
    lv_btn_set_style(buttonTravelText, LV_BTN_STYLE_REL, &tft_style_lable_rel); /*Set the button's released style*/
    lv_btn_set_style(buttonTravelText, LV_BTN_STYLE_PR, &tft_style_lable_pre);  /*Set the button's pressed style*/
