...
void lv_draw_tmc_step_mode_settings(void) {
  ...
  if (uiCfg.para_ui_page != 1) {
    ...
    lv_imgbtn_set_style(buttonXState, LV_BTN_STATE_PR, &tft_style_lable_pre);
    lv_imgbtn_set_style(buttonXState, LV_BTN_STATE_REL, &tft_style_lable_rel);
    ...
    lv_imgbtn_set_style(buttonYState, LV_BTN_STATE_PR, &tft_style_lable_pre);
    lv_imgbtn_set_style(buttonYState, LV_BTN_STATE_REL, &tft_style_lable_rel);
    ...
    lv_imgbtn_set_style(buttonZState, LV_BTN_STATE_PR, &tft_style_lable_pre);
    lv_imgbtn_set_style(buttonZState, LV_BTN_STATE_REL, &tft_style_lable_rel);
    ...
    lv_imgbtn_set_style(buttonE0State, LV_BTN_STATE_PR, &tft_style_lable_pre);
    lv_imgbtn_set_style(buttonE0State, LV_BTN_STATE_REL, &tft_style_lable_rel);
    ...
    lv_ex_line(line4, line_points[3]);
      ...
      lv_imgbtn_set_style(buttonE1State, LV_BTN_STATE_PR, &tft_style_lable_pre);
      lv_imgbtn_set_style(buttonE1State, LV_BTN_STATE_REL, &tft_style_lable_rel);
