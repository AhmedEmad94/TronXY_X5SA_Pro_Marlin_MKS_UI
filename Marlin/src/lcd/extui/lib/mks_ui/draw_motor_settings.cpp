...
void lv_draw_motor_settings(void) {
  ...
  lv_btn_set_style(buttonSteps, LV_BTN_STYLE_REL, &tft_style_lable_rel);  /*Set the button's released style*/
  lv_btn_set_style(buttonSteps, LV_BTN_STYLE_PR, &tft_style_lable_pre);   /*Set the button's pressed style*/
  ...
  lv_imgbtn_set_style(buttonStepsNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
  lv_imgbtn_set_style(buttonStepsNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
  ...
  lv_ex_line(line1, line_points[0]);
    ...
    lv_btn_set_style(buttonTMCcurrent, LV_BTN_STYLE_REL, &tft_style_lable_rel); /*Set the button's released style*/
    lv_btn_set_style(buttonTMCcurrent, LV_BTN_STYLE_PR, &tft_style_lable_pre);  /*Set the button's pressed style*/
    ...
    lv_imgbtn_set_style(buttonTMCcurrentNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
    lv_imgbtn_set_style(buttonTMCcurrentNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
    ...
    lv_ex_line(line2, line_points[1]);
      ...
      lv_btn_set_style(buttonStepMode, LV_BTN_STYLE_REL, &tft_style_lable_rel); /*Set the button's released style*/
      lv_btn_set_style(buttonStepMode, LV_BTN_STYLE_PR, &tft_style_lable_pre);  /*Set the button's pressed style*/
      ...
      lv_imgbtn_set_style(buttonStepModeNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
      lv_imgbtn_set_style(buttonStepModeNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
