...
void lv_draw_jerk_settings(void) {
  ...
  lv_btn_set_style(buttonEText, LV_BTN_STYLE_REL, &tft_style_lable_rel);  /*Set the button's released style*/
  lv_btn_set_style(buttonEText, LV_BTN_STYLE_PR, &tft_style_lable_pre);   /*Set the button's pressed style*/
